package com.recruit.framework.biz.operationlog.aspect;

import com.recruit.framework.common.util.JsonUtils;
...
public class ApiOperationLogAspect {
    ...
    @Pointcut("@annotation(com.recruit.framework.biz.operationlog.aspect.ApiOperationLog)")
